/* assisting stick for blind people using ultrasonic sensor */
...
void setup() {
   ...
   pinMode(12,OUTPUT);   //pin12 is used as GND pin  for buzzer 
   pinMode(A3,OUTPUT);   //pin A3 provides output on buzzer
}
...
void loop() {
   ...
   */
   ...
   else                     analogWrite(A3,0); //no buzzing
}
